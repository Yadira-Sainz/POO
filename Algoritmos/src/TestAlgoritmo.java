        ...
        do {
            ...
            switch (opc){
                ...
                case 10:
                    ...
                    System.out.println("Total de kilometros recorridos:");
                    kms = lector.nextInt();

                    System.out.println("Precio de la gasolina por litro:");
                    precio = lector.nextInt();

                    System.out.println("Dinero gastado en el viaje");
                    dineroGastado = lector.nextInt();

                    System.out.println("Tiempo que se tardo en HORAS");
                    tiempoHora = lector.nextInt();

                    System.out.println("Tiempo que se tardo en MINUTOS");
